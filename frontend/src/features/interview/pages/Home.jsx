...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setError(requestError.response?.data?.message || "Could not generate the interview plan.")
        }
    }
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <p className='dropzone__subtitle'>{resumeFile ? resumeFile.name : 'PDF (Max 3MB)'}</p>
                                <input
                                    ref={resumeInputRef}
                                    hidden
                                    type='file'
